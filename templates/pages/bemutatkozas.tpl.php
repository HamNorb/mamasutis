<title>Nagyi mama sütis receptjei</title>
<img src="./images/bree.jpg">
<h3>Nagyi mama</h3>
  <div class="jumbotron text-center" style="margin-bottom:0">
    <h1 style=" color:Indigo;"><b><font size="5005">Nagymamánk sütijei</font></b></h1>
    <strong> Nagyi Mami receptjei és bölcsességei</strong
  </div>
  <br><br>
  ...
  <br><br><br>
		...
		<br>
		<strong>nem is tréningeznek, hanem „csak” sokat mozognak.</strong>
		<br>
 ...
 <strong>Sütis partnerek</strong>
        <ul class="nav nav-pills flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link inactive" href="https://streetkitchen.hu/category/instant/sutik/">Street kitchen</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="https://receptneked.hu/receptek/edes-sutemenyek/">Recept neked</a>
          </li>
          <li class="nav-item">
            <a class="nav-link inactive" href="https://support.mozilla.org/hu/kb/sutik-informacio-amelyet-weboldalak-tarolnak-szami">Mozilla support</a>
          </li>
        </ul>
